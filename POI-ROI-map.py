##########################################################################################
##  (00)                           Preparation Section                                  ##
##########################################################################################

##########################################################################################
######  (00.01)                         Import Python Libraries                         ##
##########################################################################################
import folium
...
##########################################################################################
######  (00.02)                        Import Data from Database                        ##
##########################################################################################
...
PATH_DATABASE = './resources/database.xlsx'
PATH_LEGEND = './../resources/images/legend.png'
data_icons=pd.read_excel(PATH_DATABASE, index_col=None, header=[0], sheet_name='icons')
data_ROI_areas=pd.read_excel(PATH_DATABASE, index_col=None, header=[0], sheet_name='ROI_areas')
data_dist_cycles=pd.read_excel(PATH_DATABASE, index_col=None, header=[0], sheet_name='dist_cycles')
data_starting_point=pd.read_excel(PATH_DATABASE, index_col=None, header=[0], sheet_name='starting_point')

##########################################################################################
######  (00.03)                      Set Startpoint & Initiate Map                      ##
##########################################################################################
...
##########################################################################################
######  (01.01)                   Implement EU Country Borders To Map                   ##
##########################################################################################
...
##########################################################################################
######  (01.02)              Add Different Map Representations To The Menu              ##
##########################################################################################
...
##########################################################################################
######  (01.03)                    Add Cycles Of ROI Regions To Map                     ##
##########################################################################################
...
######################################################################################
##  (01.04)         Cluster Icons (Respecting Location, Category And Zoom)          ##
######################################################################################
...
######################################################################################
##  (01.07)                 Add Legend Specifying Icons And Marker                  ##
######################################################################################
image = (PATH_LEGEND)
